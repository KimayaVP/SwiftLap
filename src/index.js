...
// Get swimmer's groups
app.get('/api/groups/:swimmerId', async (req, res) => {
  try {
...
// Get coach's batches
app.get('/api/batches/:coachId', async (req, res) => {
  try {
...
// Add swimmer to batch
app.post('/api/batches/add-swimmer', async (req, res) => {
  try {
...
// Remove swimmer from batch
app.post('/api/batches/remove-swimmer', async (req, res) => {
  try {
    const { batchId, swimmerId } = req.body;
...
// Get batch members and leaderboard
app.get('/api/batches/:batchId/leaderboard', async (req, res) => {
  try {
    const { data: members } = await supabase
      .from('batch_members')
      .select('swimmer_id, profiles(id, name)')
...
// Get swimmers not in a specific batch (for adding)
app.get('/api/batches/:batchId/available/:coachId', async (req, res) => {
  try {
...
app.get('/api/comments/swimmer/:swimmerId', async (req, res) => {
  try {
    const { data, error } = await supabase
      .from('coach_comments')
...
app.get('/api/comments/swimmer-times/:swimmerId', async (req, res) => {
  try {
...
app.post('/api/coach-badges/award', async (req, res) => {
  try {
...
app.get('/api/coach-badges/swimmer/:swimmerId', async (req, res) => {
  try {
    const { data, error } = await supabase
      .from('coach_badges')
...
app.get('/api/coach-badges/coach/:coachId', async (req, res) => {
  try {
    const { data, error } = await supabase
      .from('coach_badges')
...
// Create a meet
app.post('/api/meets/create', async (req, res) => {
  try {
...
// Get swimmer's meets
app.get('/api/meets/:swimmerId', async (req, res) => {
  try {
...
// Add race result to a meet
app.post('/api/meets/add-result', async (req, res) => {
  try {
...
app.get('/api/meets/:meetId/results/:swimmerId', async (req, res) => {
  try {
...
app.get('/api/meets/pbs/:swimmerId', async (req, res) => {
  try {
    const { data, error } = await supabase
      .from('meet_results')
...
// Search meets (for adding results to existing meets)
app.get('/api/meets/search', async (req, res) => {
  try {
    const { query } = req.query;
    const { data, error } = await supabase
      .from('meets')
